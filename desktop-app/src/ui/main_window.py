...
class MainWindow(ctk.CTk):
    ...
    def create_widgets(self):
        ...
        # Load images here, AFTER the window exists — CTkImage must bind to this Tk instance.
        # Loading in __init__ before the window is visible causes "pyimage doesn't exist" errors
        # when the previous Tk window (login) has been destroyed.
        self._logo_header = _load_ctk_image("sentinel_shield.png", (32, 32))
        self._logo_dialog = _load_ctk_image("sentinel_shield.png", (48, 48))
        ...
        if self._logo_header:
            ctk.CTkLabel(title_frame, image=self._logo_header, text="").pack(side="left", padx=(0, 8))
        else:
            ctk.CTkLabel(
                title_frame,
                text="🛡️",
